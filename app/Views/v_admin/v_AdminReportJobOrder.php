...
<div class="wrapper">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="<?= base_url('Home/ReportJobOrder')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-file-alt"></i> Laporan Job Order</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">IT Support</a></li>
              <li class="breadcrumb-item"><a href="#">Report</a></li>
              <li class="breadcrumb-item active">Laporan Job Order</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
