  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#TambahInv"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
                ...
                <hr>
                <table id="TabelInv" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>
                    <th>Perangkat</th>  
...
<div class="modal fade" id="TambahInv">
...
<div class="modal fade" id="EditInv">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
...
<!--MODAL Hapus Data-->
<div class="modal fade" id="HapusInv">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#TabelInv_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
