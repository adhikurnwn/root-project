...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('Home/AdminKodeInventaris')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
                      <p>Kode Inventaris</p>
                    </a>
                  </li>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-question-circle"></i> Set-up Kode Inventaris</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#add_kd_inv"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
                &nbsp;<button class="btn btn-info float-right" type="submit"  onclick="window.location.reload(true);"><i class="fas fa-sync-alt"></i></button>
                <!--&nbsp;<button type="button" class="btn btn-info" data-card-widget="card-refresh" data-source="<?= base_url('Home/AdminKodeInventaris')?>" data-source-selector="#card-refresh-content" data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>-->
                <hr>
                <table id="tbl_kd_inv" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>
                    <th>Perangkat</th>  
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#edit_kd_inv"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_kd_inv"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<!--CONTENT MODAL-->
<!--MODAL TAMBAH DATA KODE INVENTARIS-->
<div class="modal fade" id="add_kd_inv">
          ...
          <div class="modal-content">
            ...
            <div class="col-4">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_kd_inv" data-target-input="nearest">
                        <input type="text" name="date_kd_inv" class="form-control rounded-0 datetimepicker-input" data-target="#date_kd_inv"/>
                        <div class="input-group-append" data-target="#date_kd_inv" data-toggle="datetimepicker">
              ...
              <div class="input-group">
                ...
                <input type="text" autocomplete="off" class="form-control rounded-0" name="perangkat" id="perangkat">
              </div>
              </div>
              <div class="col-3">
              <label>Kode</label>
              <div class="input-group">
                ...
                <input type="text" autocomplete="off" class="form-control rounded-0"  name="kode_inv" id="kode_inv">
              </div>
            </div>
...
<!--MODAL EDIT DATA KODE INVENTARIS-->
<div class="modal fade" id="edit_kd_inv">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
            ...
            <div class="col-4">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_kd_inv" data-target-input="nearest">
                        <input type="text" name="date_kd_inv" class="form-control rounded-0 datetimepicker-input" data-target="#date_kd_inv" disabled/>
                        <div class="input-group-append" data-target="#date_kd_inv" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar-week"></i></div>
                        </div>
                    </div>
...
<!--MODAL Hapus Data-->
<div class="modal fade" id="hapus_kd_inv">
        <div class="modal-dialog modal-dialog-centered">
...
<script>
  $(function () {
    $("#tbl_kd_inv").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_kd_inv_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
