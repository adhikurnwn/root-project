...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('Home/ReportMutasi')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
                      <p>Laporan Mutasi</p>
                    </a>
                  </li>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-file-download"></i> Laporan Mutasi Barang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
               ...
               <div class="row">
                ...
                <!--FORM FILTER-->                
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3 row">
                            <label for="date_mutasi" class="col-sm-1 col-form-label">Periode</label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_mutasi" data-target-input="nearest">
                                        <input type="text" name="date_mutasi" class="form-control datetimepicker-input" data-target="#date_mutasi"/>
                              ...
                              <label for="date_mutasi2" class="col-sm-1 col-form-label" align="center"> - </label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_mutasi2" data-target-input="nearest">
                                        <input type="text" name="date_mutasi2" class="form-control datetimepicker-input" data-target="#date_mutasi2"/>
                                          <div class="input-group-append" data-target="#date_mutasi2" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar-day"></i></div>
                                          </div>
                                    </div>
                              </div>
                ...
                <div class="col text-center">
                    ...
                    <div class="table-responsive-sm">
                        <table id="tbl_report_mutasi" class="table">
                        <thead>
                          <tr>
                            <th>Kd. Brg</th>
                            <th>Kd. Inv</th>
...
<script>
  $(function () {
    $("#tbl_report_mutasi").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_report_mutasi_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
