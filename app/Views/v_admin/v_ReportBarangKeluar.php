...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('Home/ReportBarangKeluar')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-file-export"></i> Laporan Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
               ...
               <div class="row">
                ...
                <!--FORM FILTER-->                
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3 row">
                            <label for="date_report_in" class="col-sm-1 col-form-label">Periode</label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_report_out" data-target-input="nearest">
                                        <input type="text" name="date_report_out" class="form-control datetimepicker-input" data-target="#date_report_out"/>
                                          <div class="input-group-append" data-target="#date_report_out" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar-day"></i></div>
                                          </div>
                                    </div>
                              </div>

                              <label for="date_report_out2" class="col-sm-1 col-form-label" align="center"> - </label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_report_out2" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#date_report_out2"/>
                                          <div class="input-group-append" data-target="#date_report_out2" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar-day"></i></div>
                                          </div>
                                    </div>
                              </div>
                ...
                <div class="col text-center">
                        <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-magic"></i>&nbsp; CLEAR</button>
                        <button type="button" class="btn btn-success" data-dismiss="modal"><i class="fas fa-filter"></i>&nbsp; SEARCH</button>  
                      </div>
                    </div>
                    <br>
                    <div class="table-responsive-sm">
                        <table id="tbl_report_item_out" class="table">
                        <thead>
                          <tr>
                            <th>Kd. Brg</th>
                            <th>Kd. Inv</th>
...
<script>
  $(function () {
    $("#tbl_report_item_out").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_report_item_out_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
...
<script type="text/javascript">
   //Date picker
  $('#date_report_out').datetimepicker({
        format: 'L'
    });

  $('#date_report_out2').datetimepicker({
        format: 'L'
    });
