...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                    <a href="<?= base_url('Home/AdminItemKeluar')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
                      <p>Barang Keluar</p>
                    </a>
                  </li>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-boxes"></i> Barang Keluar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#add_item_out"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
              ...
              <hr>
                <table id="tbl_item_out" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>
                    <th>No.Inv</th>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-default" data-toggle="modal" data-target="#detail_item_out"><i class="fas fa-eye"></i></a>
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#edit_item_out"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_item_out"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<!--CONTENT MODAL-->
<!--MODAL TAMBAH DATA BARANG KELUAR-->
<div class="modal fade" id="add_item_out">
          ...
          <div class="modal-content">
            ...
            <div class="col-2">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_item_out" data-target-input="nearest">
                        <input type="text" name="date_item_out" class="form-control rounded-0 datetimepicker-input" data-target="#date_item_out"/>
                        <div class="input-group-append" data-target="#date_item_out" data-toggle="datetimepicker">
              ...
              <div class="col-3">
                    <div class="form-group">
                       <label for="username">User / Pengguna</label>
                       <select class="custom-select rounded-0" name="username" id="username" required>
                          <option> </option>
                       </select>
                    </div>
              </div>
            ...
            <div class="container">
                    <div class="row">
                      <div class="col text-center">
                          <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add_to_list_item_out"><i class="fas fa-plus"></i> ADD TO LIST</button>
                      </div> 
                    </div>
                </div>
                <br>
            <div class="table-responsive-sm">
                <table id="tbl_list_item_out" class="table">
                <thead>
                  <tr>
                    <th>Kd. Brg</th>
                    <th>Kd. Inv</th>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_list_item_out"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<div class="modal fade" id="detail_item_out">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
            ...
            <div class="col-2">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_item_out" data-target-input="nearest">
                        <input type="text" name="date_item_out" class="form-control rounded-0 datetimepicker-input" data-target="#date_item_out" disabled/>
                        <div class="input-group-append" data-target="#date_item_out" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar-week"></i></div>
                        </div>
                    </div>
...
<!--MODAL EDIT DATA BARANG KELUAR-->
<div class="modal fade" id="edit_item_out">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
...
<div class="modal fade" id="cari_item">
...
<!--MODAL Hapus Data Tabel Item Out-->
  <div class="modal fade" id="hapus_item_out">
        <div class="modal-dialog modal-dialog-centered">
...
<!--MODAL Hapus Data Tabel List item out-->
<div class="modal fade" id="hapus_list_item_out">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content modal-dialog-centered">
            <div class="modal-header">
              <h6 class="modal-title">Alert!</h6>
...
<script>
  $(function () {
    $("#tbl_item_out").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_item_out_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
