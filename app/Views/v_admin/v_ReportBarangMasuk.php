               ...
               <div class="row">
                ...
                <!--FORM FILTER-->                
                      <div class="row">
                        <div class="col-12">
                          <div class="mb-3 row">
                            <label for="date_brg_in" class="col-sm-1 col-form-label">Periode</label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_report_in" data-target-input="nearest">
                                        <input type="text" name="date_report_in" class="form-control datetimepicker-input" data-target="#date_report_in"/>
                                          <div class="input-group-append" data-target="#date_report_in" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar-day"></i></div>
                                          </div>
                                    </div>
                              </div>

                              <label for="date_brg_in2" class="col-sm-1 col-form-label" align="center"> - </label>
                              <div class="form-group">
                                    <div class="input-group date" id="date_report_in2" data-target-input="nearest">
                                        <input type="text" name="date_report_in2" class="form-control datetimepicker-input" data-target="#date_report_in2"/>
                                          <div class="input-group-append" data-target="#date_report_in2" data-toggle="datetimepicker">
                                            <div class="input-group-text"><i class="fa fa-calendar-day"></i></div>
                                          </div>
                                    </div>
                              </div>
                ...
                <!--END FORM FILTER-->
                    ...
                    <div class="table-responsive-sm">
                        <table id="tbl_report_item_in" class="table">
                        <thead>
                          <tr>
                            <th>Kd. Brg</th>
                            <th>Kd. Inv</th>
                    ...
                    <br>
                    <div class="col text-center">
                        <!--<button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-file-pdf"></i>&nbsp; SAVE AS PDF</button>
...
<script>
  $(function () {
    $("#tbl_report_item_in").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_report_item_in_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
...
<script type="text/javascript">
   //Date picker
  $('#date_report_in').datetimepicker({
        format: 'L'
    });

  $('#date_report_in2').datetimepicker({
        format: 'L'
    });
