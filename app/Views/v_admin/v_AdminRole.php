...
<div class="wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-question-circle"></i> Set-up Role</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                ...
                &nbsp;<button type="button" class="btn btn-info" data-card-widget="card-refresh" data-source="<?= base_url('Home/AdminRole')?>" data-source-selector="#card-refresh-content" data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>
                <hr>
