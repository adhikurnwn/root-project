        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item menu-open">
                    <a href="<?= base_url('Home/AdminRole')?>" class="nav-link active">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#TambahRole"><i class="fas fa-plus"></i> Tambah Role</a>
              <hr>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#EditRole"><i class="fas fa-edit"></i> Edit</a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#HapusRole"><i class="fas fa-trash"></i> Hapus</a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="custom-select rounded-0" id="exampleSelectRounded0" required>
                  <option selected disabled>Select a type code role</option>
                    <option>USR</option>
                    <option>DH</option>
                    <option>ADM</option>
                  </select>
