...
<div class="wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-question-circle"></i> Set-up Satuan</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#add_satuan"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
                &nbsp;<button class="btn btn-info float-right" type="submit"  onclick="window.location.reload(true);"><i class="fas fa-sync-alt"></i></button>
                <!--&nbsp;<button type="button" class="btn btn-info" data-card-widget="card-refresh" data-source="<?= base_url('Home/AdminSatuan')?>" data-source-selector="#card-refresh-content" data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>-->
                <hr>
                <table id="tbl_satuan" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>  
                    <th>Kode</th>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#edit_satuan"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_satuan"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<div class="modal fade" id="add_satuan">
          ...
          <div class="modal-content">
            ...
            <div class="col-4">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_satuan" data-target-input="nearest">
                        <input type="text" name="date_satuan" class="form-control rounded-0 datetimepicker-input" data-target="#date_satuan"/>
                        <div class="input-group-append" data-target="#date_satuan" data-toggle="datetimepicker">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control rounded-0"  name="kode_satuan" id="kode_satuan">
              </div>
              </div>
              <div class="col-5">
              <label>Satuan</label>
              <div class="input-group">
                ...
                <input type="text" class="form-control rounded-0" name="satuan" id="satuan">
              </div>
              </div>
            </div>
            <!--END JOB REQUEST-->
          ...
          <div class="modal-content">
            ...
            <div class="col-4">
              <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_satuan" data-target-input="nearest">
                        <input type="text" name="date_satuan" class="form-control rounded-0 datetimepicker-input" data-target="#date_satuan" disabled/>
                        <div class="input-group-append" data-target="#date_satuan" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar-week"></i></div>
                        </div>
                    </div>
...
<!--MODAL Hapus Data-->
<div class="modal fade" id="hapus_satuan">
        <div class="modal-dialog modal-dialog-centered">
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#tbl_satuan_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
