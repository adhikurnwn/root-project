...
<div class="wrapper">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= base_url('Home/AdminBussinesUnit')?>" class="nav-link active">
                    &emsp;<i class="far fa-dot-circle nav-icon"></i>
                      <p>Bussines Unit</p>
                    </a>
                  </li>
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-question-circle"></i> Set-up Bussines Unit</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#add_buss_unit"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
                &nbsp;<button class="btn btn-info float-right" type="submit"  onclick="window.location.reload(true);"><i class="fas fa-sync-alt"></i></button>
                <!--&nbsp;<button type="button" class="btn btn-info" data-card-widget="card-refresh" data-source="<?= base_url('Home/AdminBussinesUnit')?>" data-source-selector="#card-refresh-content" data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>-->
                <hr>
                <table id="tbl_buss_unit" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>  
                    <th>Kode</th>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#edit_buss_unit"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_buss_unit"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<!--CONTENT MODAL-->
<!--MODAL TAMBAH DATA BUSSINES UNIT-->
<div class="modal fade" id="add_buss_unit">
          ...
          <div class="modal-content">
            ...
            <div class="col-4">
                <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_buss_unit" data-target-input="nearest">
                        <input type="text" name="date_buss_unit" class="form-control rounded-0 datetimepicker-input" data-target="#date_buss_unit"/>
                        <div class="input-group-append" data-target="#date_buss_unit" data-toggle="datetimepicker">
              ...
              <label>Kode</label>
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" class="form-control rounded-0" name="kode_buss_unit" id="kode_buss_unit">
                </div>
              </div>
              <div class="col-5">
              <label>Bussines Unit</label>
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" class="form-control rounded-0" name="buss_unit" id="buss_unit">
                </div>
              </div>
              <div class="col-12">
              <div class="form-group">
                    <label>Alamat</label>
                      <textarea class="form-control" rows="3" name="alamat_buss_unit" id="alamat_buss_unit"></textarea>
              </div>
              </div>
            </div>
            <!--END JOB REQUEST-->
...
<!--MODAL EDIT DATA BU-->
<div class="modal fade" id="edit_buss_unit">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
            ...
            <div class="col-4">
                <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_buss_unit" data-target-input="nearest">
                        <input type="text" name="date_buss_unit" class="form-control rounded-0 datetimepicker-input" data-target="#date_buss_unit" disabled/>
                        <div class="input-group-append" data-target="#date_buss_unit" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar-week"></i></div>
                        </div>
                    </div>
...
<!--MODAL Hapus Data-->
<div class="modal fade" id="hapus_buss_unit">
        <div class="modal-dialog modal-dialog-centered">
...
<script>
  $(function () {
    $("#tbl_buss_unit").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tbl_buss_unit_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
