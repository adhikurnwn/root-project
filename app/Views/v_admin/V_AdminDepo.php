...
<div class="wrapper">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-question-circle"></i> Set-up Depo</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#add_depo"><i class="fas fa-plus-circle"></i> CREATE NEW</a>
                &nbsp;<button class="btn btn-info float-right" type="submit"  onclick="window.location.reload(true);"><i class="fas fa-sync-alt"></i></button>
                <!--&nbsp;<button type="button" class="btn btn-info" data-card-widget="card-refresh" data-source="<?= base_url('Home/AdminDepo')?>" data-source-selector="#card-refresh-content" data-load-on-init="false"><i class="fas fa-sync-alt"></i></button>-->
                <hr>
                <table id="tbl_depo" class="table table-bordered table-striped" cellspacing="0" width="150%">
                  <thead>
                  <tr>
                    <th>Created</th>  
                    <th>Kode</th>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#edit_depo"><i class="fas fa-edit"></i></a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#hapus_depo"><i class="fas fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
<div class="modal fade" id="add_depo">
          ...
          <div class="modal-content">
            ...
            <div class="col-4">
                <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_depo" data-target-input="nearest">
                        <input type="text" name="date_depo" class="form-control rounded-0 datetimepicker-input" data-target="#date_depo"/>
                        <div class="input-group-append" data-target="#date_depo" data-toggle="datetimepicker">
              ...
              <label>Kode</label>
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" class="form-control rounded-0" name="kode_depo" id="kode_depo">
                </div>
              </div>
              <div class="col-5">
              <label>Depo</label>
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" class="form-control rounded-0" name="depo" id="depo">
                </div>
              </div>
              <div class="col-12">
              <div class="form-group">
                    <label>Alamat</label>
                      <textarea class="form-control" rows="3" name="alamat_depo" id="alamat_depo"></textarea>
              </div>
              </div>
            </div>
            <!--END JOB REQUEST-->
...
<!--MODAL EDIT DATA DEPO-->
<div class="modal fade" id="edit_depo">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h6 class="modal-title"><i>Silahkan Lengkapi Data Dibawah ini!</i></h6>
            ...
            <div class="col-4">
                <div class="form-group">
                  <label>Created</label>
                    <div class="input-group date" id="date_depo" data-target-input="nearest">
                        <input type="text" name="date_depo" class="form-control rounded-0 datetimepicker-input" data-target="#date_depo" disabled/>
                        <div class="input-group-append" data-target="#date_depo" data-toggle="datetimepicker">
                            <div class="input-group-text"><i class="fa fa-calendar-week"></i></div>
                        </div>
                    </div>
              ...
              <label>Kode</label>
                <div class="input-group">
                  ...
                  <input type="text" autocomplete="off" class="form-control rounded-0" name="date_depo" id="date_depo">
                </div>
              </div>
              <div class="col-md-5">
              <label>Depo</label>
...
<!--MODAL Hapus Data-->
<div class="modal fade" id="hapus_depo">
        <div class="modal-dialog modal-dialog-centered">
...
<script>
  $(function () {
    ...
    }).buttons().container().appendTo('#tbl_depo_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
