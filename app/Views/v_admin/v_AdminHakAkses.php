...
<div class="wrapper">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('Home/AdminHakAkses')?>" class="nav-link active">
  ...
  <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><i class="fas fa-user-shield"></i> Set-up Hak Akses</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card">
              <div class="card-body">
                <a href="#" class="btn btn-success" data-toggle="modal" data-target="#TambahHakAkses"><i class="fas fa-plus"></i> Tambah Hak Akses</a>
              <hr>
                  ...
                  <tr>
                    ...
                    <td class="text-left py-1 align-middle">
                      <div class="btn-group btn-group-sm">
                        <a href="#" class="btn btn-info" data-toggle="modal" data-target="#EditHakAkses"><i class="fas fa-edit"></i> Edit</a>
                        <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#HapusHakAkses"><i class="fas fa-trash"></i> Hapus</a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
            ...
            <div class="row">
              ...
              <div class="col-3">
                <div class="form-group">
                  ...
                  <option selected disabled>Select a type role</option>
                    <option> </option>
                  </select>
                </div>
              </div>
              <div class="col-9">
                <div class="form-group">
                  ...
                  <select class="custom-select rounded-0" id="exampleSelectRounded0" required>
                  <option selected disabled>Select a type department</option>
                    <option> </option>
                  </select>
                </div>
              </div>
              <div class="col-3">
                <div class="form-group">
                  ...
                  <select class="custom-select rounded-0" id="exampleSelectRounded0" required>
                  <option selected disabled>Select a type status</option>
                    <option> </option>
                  </select>
                </div>
              </div>
